...
impl StreamContext {
    ...
    pub fn set_prompt_cache_usage(&mut self, prompt_cache_usage: PromptCacheUsage) {
    ...
    pub fn create_message_start_event(&self) -> serde_json::Value {
        let billed_input_tokens = self
            .prompt_cache_usage
            .billed_input_tokens_for(self.input_tokens);
        json!({
            "type": "message_start",
            "message": {
                "id": self.message_id,
                ...
                "usage": {
                    ...
                    "output_tokens": 1,
                    "cache_creation_input_tokens": self.prompt_cache_usage.cache_creation_input_tokens,
                    "cache_read_input_tokens": self.prompt_cache_usage.cache_read_input_tokens
                }
            }
        })
    }
    ...
    pub fn generate_final_events(&mut self) -> Vec<SseEvent> {
        ...
        let raw_input_tokens = self.context_input_tokens.unwrap_or(self.input_tokens);
        let final_prompt_cache_usage = self
            .prompt_cache_usage
...
impl BufferedStreamContext {
    ...
    pub fn set_prompt_cache_usage(&mut self, prompt_cache_usage: PromptCacheUsage) {
        self.inner.set_prompt_cache_usage(prompt_cache_usage);
    }
    ...
    pub fn finish_and_get_all_events(&mut self) -> Vec<SseEvent> {
        ...
        let final_prompt_cache_usage = self
            .inner
            .prompt_cache_usage
            .with_actual_input_tokens(final_input_tokens);
        let billed_input_tokens = final_prompt_cache_usage.billed_input_tokens;
                ...
                if let Some(message) = event.data.get_mut("message") {
                    if let Some(usage) = message.get_mut("usage") {
                        ...
                        usage["cache_creation_input_tokens"] =
                            serde_json::json!(final_prompt_cache_usage.cache_creation_input_tokens);
                        usage["cache_read_input_tokens"] =
                            serde_json::json!(final_prompt_cache_usage.cache_read_input_tokens);
                    }
                }
            }
